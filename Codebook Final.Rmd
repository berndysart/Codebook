...
=======
>>>>>>> e95eebdf7d07c7df9112f3008cc72e9596aa1a28
```
...
Data in the World Values Survey (WVS) dataset and European Values Survey (EVS) dataset was collected via surveys administrerd durinng interviews with respondents.
...
The EVS data is from 1981-2021, covering 49 European countries altogether particpants in particular. 160 surveys over five waves and 40 years is included in the data set. The survey question explore difference and similarity in value and teh changes in valye among citizens of the surveyed countries. 
...
- Factor Variable
- Captures responses to survey question: How often does the individuall follow politics in the news
```{r political interest, echo = FALSE}
<<<<<<< HEAD
cbfactor(EWM, p_interest)
=======
count(EWM, p_interest) |>
  kable()
>>>>>>> e95eebdf7d07c7df9112f3008cc72e9596aa1a28
```
